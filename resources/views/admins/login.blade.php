...
@section('main')
    <section class="column p-10  w-full flex-auto justify-center">
        <form style="backdrop-filter: blur(20px);box-shadow:inset 0 0 50px var(--bg-light)"  action="{{ url('admins/post/login/process') }}" method="POST" onsubmit="PostRequest(event,this,call_back)" class="w-full max-w-500 align-center br-10 bg-primary-transparent c-white column g-5 p-10">
