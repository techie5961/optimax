...
@section('main')
     <section class="w-full g-10 p-10 column flex-auto align-center">
        ...
        <div class="bg-transparent backdrop-blur-50 w-full column g-10 max-w-500 br-10 p-10">
         ...
         <span style="font-family:titan one;font-weight:100" class="desc bold">Update Profile Photo</span>
...
<path d="M20 17.5C20 19.9853 20 22 12 22C4 22 4 19.9853 4 17.5C4 15.0147 7.58172 13 12 13C16.4183 13 20 15.0147 20 17.5Z" fill="CurrentColor"></path>
            ...
            <form enctype="multipart/form-data" action="{{ url('users/post/update/profile/photo/process') }}" method="POST" onsubmit="PostRequest(event,this,MyFunc.Updated)" class="w-full column g-10">
               <input type="hidden" class="input" name="_token" value="{{ @csrf_token() }}">
                <label style="border:2px dashed var(--primary)" class="w-full label pointer no-select column justify-center text-center perfect-square clip-20 br-20 bg-black">
